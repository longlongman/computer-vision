...
for i = 2 : nr + 1
    ...
    [TI{i, 1}, E] = addHorSeam(TI{i-1, 1}, My, Tby);
...
for i = 2 : nc+1
	...
	[TI{1, i}, E] = addVerSeam(TI{1, i-1}, Mx, Tbx);
	T(1, i) = T(1, i-1) + E;
end
...
for i = 2 : nr+1
    for j = 2 : nc+1
        ...
        [My, Tby] = cumMinEngHor(e);
        [Iy, Ey] = addHorSeam(TI{i-1, j}, My, Tby);
        
        e = genEngMap(TI{i, j-1});
        [Mx, Tbx] = cumMinEngVer(e);
        [Ix, Ex] = addVerSeam(TI{i, j-1}, Mx, Tbx);
