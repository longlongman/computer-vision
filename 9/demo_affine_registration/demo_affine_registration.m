...
%% »ñÈ¡Á½·ùÍ¼Ïñ
im1 = imread('bottle1.jpg');
im2 = imread('bottle2.jpg');
...
%    imTotal(rowlo_i :rowhi_i, collo_i:colhi_i, :) = imTotal(rowlo_i :rowhi_i, collo_i:colhi_i, :)  + im_i .* repmat(mask_i, [1 1 nc]);
%    maskTotal(rowlo_i :rowhi_i, collo_i:colhi_i) = maskTotal(rowlo_i :rowhi_i, collo_i:colhi_i) + mask_i;
end
